...
/**
 * This is the model class for table "familyposition".
 *
 * @property int $id
 ...
 */
class Familyposition extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(Punishedperson::className(), ['familypositionId' => 'id']);
    }
}
